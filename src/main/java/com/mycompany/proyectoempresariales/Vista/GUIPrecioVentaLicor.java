 ...
 * @author andre
 */
public class GUIPrecioVentaLicor extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GUIPrecioVentaLicor.class.getName());

    /**
     * Creates new form GUIPrecioVentaLicor
     */
    public GUIPrecioVentaLicor() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GUIPrecioVentaLicor().setVisible(true));
    }
